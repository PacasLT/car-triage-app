...
(function () {
  ...
  var CSS = ''
    ...
    + '.ct-meg-btn:hover,.ct-meg-btn.open{color:#ff5c8a;border-color:rgba(255,92,138,.5)}'
    + '.ct-meg-btn.yra svg{fill:#ff5c8a;stroke:#ff5c8a}'
    + '.ct-meg-btn.yra{color:#ff5c8a}'
    + '.ct-meg-kiek{position:absolute;top:-4px;right:-4px;min-width:18px;height:18px;padding:0 5px;border-radius:9px;background:#ff5c8a;color:#fff;font:700 10px/18px var(--font-mono,monospace);text-align:center;border:2px solid var(--bg-base,#0a0c12);box-sizing:content-box;display:none}'
