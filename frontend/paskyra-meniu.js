...
(function () {
  ...
  var CSS = ''
    ...
    + '.ct-pask-head{display:flex;align-items:center;gap:11px;padding:15px 15px 13px;'
      ...
      + 'background:radial-gradient(120% 140% at 0% 0%,var(--accent-dim),transparent 62%)}'
    + '.ct-pask-av{width:38px;height:38px;border-radius:12px;background:var(--accent);color:#fff;display:grid;place-items:center;font:700 15px var(--font,sans-serif);flex:none}'
    ...
    + '.ct-pask-pl{font:700 10px/1 var(--font-mono,monospace);color:var(--accent-light,#a99cff);background:var(--accent-dim);border:1px solid var(--accent-border);padding:3px 6px;border-radius:5px}'
    ...
    + '.ct-pask-it:hover .ic{border-color:var(--accent-border);color:var(--accent-light,#a99cff)}'
    ...
    + '.ct-pask-it .n.ac{color:var(--accent-light,#a99cff);background:var(--accent-dim);border-color:var(--accent-border)}'
    + '.ct-pask-it .n.sirdis{color:var(--accent-light);background:var(--accent-dim);border-color:var(--accent-border)}'
    + '.ct-pask-tesk{font:600 10.5px var(--font,sans-serif);color:var(--accent-light,#a99cff);background:var(--accent-dim);border:1px solid var(--accent-border);padding:5px 9px;border-radius:8px;text-decoration:none;white-space:nowrap}'
    + '.ct-pask-tesk:hover{background:var(--accent);color:#fff}'
