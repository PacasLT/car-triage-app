...
| Nr. | Kas | Trumpai |
|---|---|---|
| TA | Pilna `ta-modeliai.json` iš 12 212 462 įrašų (`tools/ta-suvestine.py`) | **Parsisiųsta 09-22**: `Downloads\ta-apziuros-*.csv` 105 failai, ištisai, be dublikatų. Analitiko ėjimas. Repo `ta-modeliai.json` – bandomasis X5, necommit'inti. Duomenys iki 2025-05-28. |
